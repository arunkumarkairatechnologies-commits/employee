<?php
// admin/view_task.php - Modern Task View with Chat
session_start();
...
// Fetch task data
$stmt = $conn->prepare("SELECT t.*, u.name as assigned_to_name, (SELECT GROUP_CONCAT(name SEPARATOR ', ') FROM users WHERE FIND_IN_SET(id, t.observer_id) > 0) as observer_name FROM tasks t JOIN users u ON u.id = t.employee_id WHERE t.id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['post_comment'])) {
    ...
    if (!empty($message) || $attachment) {
        ...
        // Notification
        $msg = "New comment on task: " . $task['title'];
        $conn->query("INSERT INTO notifications (user_id, message) VALUES ({$task['employee_id']}, '$msg')");
    ...
    <div class="main-content">
        <div class="container-fluid p-0">
            <div class="mb-3 d-flex align-items-center">
                <a href="tasks.php" class="btn btn-sm btn-outline-secondary me-3"><i class="fas fa-arrow-left"></i> Back</a>
            ...
            <div class="task-detail-container">
                ...
                <div class="task-info-pane">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <?php if ($task['status'] !== 'completed'): ?>
                            <form method="POST" class="m-0">
                                <button type="submit" name="mark_complete" class="btn btn-success btn-sm shadow-sm">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            <p class="text-muted fw-bold mb-1"><i class="fas fa-user-tie me-1"></i> Assigned To</p>
                            <p>
                                <img src="../assets/img/user.png" width="24" height="24" class="rounded-circle me-1 border border-secondary" onerror="this.style.display='none'">
                                <strong><?php echo htmlspecialchars($task['assigned_to_name']); ?></strong>
                            </p>
                        </div>
                        <div class="col-md-4">
                            ...
                            <p>
                                <?php if($task['observer_name']): ?>
                                    <img src="../assets/img/user.png" width="24" height="24" class="rounded-circle me-1 border border-secondary" onerror="this.style.display='none'">
                                    <strong><?php echo htmlspecialchars($task['observer_name']); ?></strong>
                                <?php else: ?>
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <?php if ($task['user_attachment']): ?>
                                <a href="../assets/uploads/<?php echo htmlspecialchars($task['user_attachment']); ?>" download target="_blank" class="btn btn-sm btn-outline-info shadow-sm">
                                    <i class="fas fa-download me-1"></i> Download User File
                                </a>
                            <?php endif; ?>
                        </div>
                    </div>
